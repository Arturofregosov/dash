...
col1.metric("lo que sea","lo que sea", "lo que sea", style={"background-color": "blue"})
col2.metric("lo que sea","lo que sea", "lo que sea", style={"background-color": "blue"})
col3.metric("lo que sea","lo que sea", "lo que sea", style={"background-color": "blue"})
